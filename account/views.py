...
def forgot_password(request):
   ...
   link = "{host}auth/reset_password/{token}".format(host=host,token=token)
   body = "Youre password reset link is :{link}".format(link=link)
   ...
   return Response({'message':'Password reset email send to :{email}'.format(email=data['email'])})
